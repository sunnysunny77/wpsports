	...
	<div class="content-area col-xl-8 mx-auto padding-0" >
		...
		<div class="text-center pb-5 pl-3 pr-3 pl-xl-5 pr-xl-5 ">
			...
			<span  class="aspan d-block d-lg-inline-block position-relative textmain font-weight-bold pr-5 pl-5 move-in-up" > 
				...
				<button class="btn-sm bgsix  bodmain textmain rounded-0 " type="button" data-toggle="collapse" data-target="#collapseExample" aria-expanded="false" aria-controls="collapseExample">
						see more
				</button>		
		...
		<div class="rad col-12 mx-auto bgfour  padding-0 text-center pt-5 pb-5" >
			...
			?>
			<a href="<?php echo $link1['url']; ?>" target="<?php echo $link1['target']; ?>"class="per badge ah   bgfive border-0  ">
			
				<img  src="<?php the_field("spon_img_1") ?>" alt="spon_img_1" width="40px" height="40px" />
				<br>
				<br>
				<?php echo $link1['title']; ?> 
				
			</a>
			<a href="<?php echo $link2['url']; ?>" target="<?php echo $link2['target']; ?>"class="per badge ah   bgfive border-0  ">
			
				<img  src="<?php the_field("spon_img_2") ?>" alt="spon_img_2" width="40px" height="40px" />
				<br>
				<br>
				<?php echo $link2['title']; ?> 
				
			</a>
			<a href="<?php echo $link3['url']; ?>" target="<?php echo $link3['target']; ?>"class="per badge ah  bgfive border-0  ">
				
				<img  src="<?php the_field("spon_img_3") ?>" alt="spon_img_3" width="40px" height="40px" />
				<br>
				<br>
				<?php echo $link3['title']; ?>
				
			</a>
			<a href="<?php echo $link4['url']; ?>" target="<?php echo $link4['target']; ?>"class="per badge ah  bgfive  border-0  ">
				
				<img  src="<?php the_field("spon_img_4") ?>" alt="spon_img_4" width="40px" height="40px" />
				<br>
				<br>
				<?php echo $link4['title']; ?>
				
			</a>
			<a href="<?php echo $link5['url']; ?>" target="<?php echo $link5['target']; ?>"class="per badge ah   bgfive  border-0  ">
				
				<img  src="<?php the_field("spon_img_5") ?>" alt="spon_img_5" width="40px" height="40px" />
				<br>
				<br>
				<?php echo $link5['title']; ?>
				
			</a>
			<a href="<?php echo $link6['url']; ?>" target="<?php echo $link6['target']; ?>"class="per  badge ah  bgfive  border-0 ">
				
				<img   src="<?php the_field("spon_img_6") ?>" alt="spon_img_6" width="40px" height="40px" />	
				<br>
				<br>
